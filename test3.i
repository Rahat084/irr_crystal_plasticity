...
[AuxVariables]
  ...
  [dislocation_density_2]
    ...
    family = MONOMIAL
  []
  [dislocation_density_3]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_4]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_5]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_6]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_7]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_8]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_9]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_10]
    order = CONSTANT
    family = MONOMIAL
  []
  [dislocation_density_11]
    order = CONSTANT
    family = MONOMIAL
  []
[]
...
[AuxKernels]
  ...
  [dislocation_density_0]
   type = MaterialStdVectorAux
   variable = dislocation_density_0
  ...
  [dislocation_density_3]
   type = MaterialStdVectorAux
   variable = dislocation_density_3
   property = dislocation_density
   index = 3
   execute_on = timestep_end
  []
  [dislocation_density_4]
   type = MaterialStdVectorAux
   variable = dislocation_density_4
   property = dislocation_density
   index = 4
   execute_on = timestep_end
  []
  [dislocation_density_5]
   type = MaterialStdVectorAux
   variable = dislocation_density_5
   property = dislocation_density
   index = 5
   execute_on = timestep_end
  []
  [dislocation_density_6]
   type = MaterialStdVectorAux
   variable = dislocation_density_6
   property = dislocation_density
   index = 6
   execute_on = timestep_end
  []
  [dislocation_density_7]
   type = MaterialStdVectorAux
   variable = dislocation_density_7
   property = dislocation_density
   index = 7
   execute_on = timestep_end
  []
  [dislocation_density_8]
   type = MaterialStdVectorAux
   variable = dislocation_density_8
   property = dislocation_density
   index = 8 
   execute_on = timestep_end
  []
  [dislocation_density_9]
   type = MaterialStdVectorAux
   variable = dislocation_density_9
   property = dislocation_density
   index = 9 
   execute_on = timestep_end
  []
  [dislocation_density_10]
   type = MaterialStdVectorAux
   variable = dislocation_density_10
   property = dislocation_density
   index = 10
   execute_on = timestep_end
  []
  [dislocation_density_11]
   type = MaterialStdVectorAux
   variable = dislocation_density_11
   property = dislocation_density
   index = 11
   execute_on = timestep_end
  []
