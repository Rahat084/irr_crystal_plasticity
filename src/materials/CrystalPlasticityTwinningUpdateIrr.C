...
#include "CrystalPlasticityTwinningUpdateIrr.h"
#include "libmesh/int_range.h"

registerMooseObject("SolidMechanicsApp", CrystalPlasticityTwinningUpdateIrr);

InputParameters
CrystalPlasticityTwinningUpdateIrr::validParams()
{
...
CrystalPlasticityTwinningUpdateIrr::CrystalPlasticityTwinningUpdateIrr(
...
void
CrystalPlasticityTwinningUpdateIrr::initQpStatefulProperties()
{
...
void
CrystalPlasticityTwinningUpdateIrr::setMaterialVectorSize()
{
...
void
CrystalPlasticityTwinningUpdateIrr::setInitialConstitutiveVariableValues()
{
...
void
CrystalPlasticityTwinningUpdateIrr::setSubstepConstitutiveVariableValues()
{
...
bool
CrystalPlasticityTwinningUpdateIrr::calculateSlipRate()
{
...
void
CrystalPlasticityTwinningUpdateIrr::calculateConstitutiveSlipDerivative(
...
bool
CrystalPlasticityTwinningUpdateIrr::areConstitutiveStateVariablesConverged()
{
...
void
CrystalPlasticityTwinningUpdateIrr::updateSubstepConstitutiveVariableValues()
{
...
void
CrystalPlasticityTwinningUpdateIrr::cacheStateVariablesBeforeUpdate()
{
...
void
CrystalPlasticityTwinningUpdateIrr::calculateStateVariableEvolutionRateComponent()
{
  for (const auto i : make_range(_number_slip_systems))
...
bool
CrystalPlasticityTwinningUpdateIrr::updateStateVariables()
{
...
bool
CrystalPlasticityTwinningUpdateIrr::calculateTwinVolumeFraction()
{
...
void
CrystalPlasticityTwinningUpdateIrr::calculateTwinResistance()
{
