...
/**
 * CrystalPlasticityTwinningUpdateIrr uses the multiplicative decomposition
...
class CrystalPlasticityTwinningUpdateIrr : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityTwinningUpdateIrr(const InputParameters & parameters);
