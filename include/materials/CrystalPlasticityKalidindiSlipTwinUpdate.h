...
class CrystalPlasticityKalidindiSlipTwinUpdate;

/**
 * CrystalPlasticityKalidindiSlipTwinUpdate uses the multiplicative decomposition of the
...
class CrystalPlasticityKalidindiSlipTwinUpdate : public CrystalPlasticityStressUpdateBase
{
public:
  static InputParameters validParams();

  CrystalPlasticityKalidindiSlipTwinUpdate(const InputParameters & parameters);
