...
[AuxVariables]
  ...
  [slip_accumulation_9]
    ...
    family = MONOMIAL
  []
  [slip_accumulation_10]
    order = CONSTANT
    family = MONOMIAL
  []
  [slip_accumulation_11]
    order = CONSTANT
    family = MONOMIAL
  []
...
[AuxKernels]
  ...
  [slip_accumulation_0]
   type = MaterialStdVectorAux
   variable = slip_accumulation_0
   property = slip_accumulation
   index = 0
   execute_on = timestep_end
  []
  [slip_accumulation_1]
   type = MaterialStdVectorAux
   variable = slip_accumulation_1
   property = slip_accumulation
   index = 1
   execute_on = timestep_end
  []
...
[Materials]
  ...
  [slip_xtalpl]
    ...
    frank_loop_diameter = 5.5E-6 # 5.5 nm diameter
